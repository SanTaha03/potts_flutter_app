...
import 'package:flutterapplication/features/plantes/presentation/screens/plant_detail_screen.dart';
...
class _PlantesScreenState extends State<PlantesScreen> {
  int _viewIndex = 0; // 0 for List, 1 for Plan
  ...
  Widget _buildViewToggle() {
    return Container(
      ...
      child: ToggleButtons(
        ...
        borderRadius: BorderRadius.circular(20),
        selectedColor: const Color(0xFF384A37),
        color: const Color(0xFF536A50),
        fillColor: const Color(0xFF9AB291),
        renderBorder: false,
        children: const [
          Padding(
    ...
    return Row(
      children: [
        ...
        Container(
          ...
          child: const Icon(Icons.filter_list, color: Color(0xFF536A50)),
        ),
      ],
    );
  }
